...
assertClose(Sim.getCrowdingFatigueCoefficient(2), 1.1, 1e-6, 'Crowding 1-3 fatigue coefficient mismatch');
assertClose(Sim.getCrowdingFatigueCoefficient(4.2), 1.2, 1e-6, 'Crowding 3-5 fatigue coefficient mismatch');
assertClose(Sim.getCrowdingFatigueCoefficient(6.5), 1.3, 1e-6, 'Crowding >5 fatigue coefficient mismatch');
...
assertClose(Sim.getNoiseFatigueCoefficient(75), 1.1, 1e-6, 'Noise 70-80 fatigue coefficient mismatch');
assertClose(Sim.getNoiseFatigueCoefficient(85), 1.3, 1e-6, 'Noise >80 fatigue coefficient mismatch');
